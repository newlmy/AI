...
var Curve = function () {
  function Curve() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, Curve);

    this.pointArr = option.pointArr || [];
    this.startPointArr = this.pointArr.map(function (arr) {
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Curve, [{
    key: 'init',
    value: function init() {
      ...
      this.isDrawDot = true;
      this.curveList = null;
      this.newPointIndexAtClosed = null;
      this.reDraw();
    }
  }, {
    key: 'addEvent',
    ...
    key: 'paintPoint',
    value: function paintPoint(point) {
    ...
    key: 'paintPolyLine',
    value: function paintPolyLine(points) {
      var ctx = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.ctx;
    ...
    key: 'setCurvefragment',
    value: function setCurvefragment() {
    ...
    key: 'getCurveList',
    value: function getCurveList(arr) {
      var a = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.15;
      var b = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.15;
      ...
      list = list.map(function (arr) {
        var p0 = [arr[1][0] + a * (arr[2][0] - arr[0][0]), arr[1][1] + a * (arr[2][1] - arr[0][1])];
        var p1 = [arr[2][0] - b * (arr[3][0] - arr[1][0]), arr[2][1] - b * (arr[3][1] - arr[1][1])];
    ...
    key: 'setCurvePath',
    value: function setCurvePath(list, ctx) {
      var _this = this;
      ...
      list.forEach(function (x, y) {
        if (y === 0 || y === list.length - 1) {
          _this.ctx.lineTo(x[3][0], x[3][1]);
        } else {
          _this.setCurvefragment(x, ctx);
        }
      });
    }
  }, {
    key: 'drawCurvePath',
    value: function drawCurvePath(arr, ctx) {
    ...
    key: 'withDraw',
    value: function withDraw(point) {
      if (this.pointArr.length <= 3 && this.isClosed) {
        return;
      }
      if (this.newPointIndexAtClosed === null) {
        this.pointArr.pop();
      } else {
    ...
    key: 'reDrawAtDrawingDot',
    value: function reDrawAtDrawingDot() {
      var _this2 = this;

      this.pointArr.forEach(function (point) {
        return _this2.paintPoint(point);
      });
      ...
      if (len < 3) {
        ...
        this.curveList = this.getCurveList(this.pointArr).filter(function (x, y, z) {
          return y !== z.length - 1;
        });
    ...
    key: 'reDrawAtClosedDot',
    value: function reDrawAtClosedDot() {
      var _this3 = this;

      this.ctx.save();
      this.pointArr.forEach(function (point) {
        return _this3.paintPoint(point);
      });
      this.setCurvePath(this.curveList);
      this.ctx.stroke();
      if (this.isFill) {
    ...
    key: 'getClickPointInd',
    value: function getClickPointInd(clickCoord) {
      var points = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.pointArr;

      var len = points.length;
      for (var i = 0; i < len; i++) {
        if (this.getPointDistance(points[i], clickCoord) <= this.pointSize) {
          return i;
        }
      }
      return false;
    ...
    value: function replace(arr) {
      var opiton = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      this.isClosed = opiton.isClosed || true;
      this.pointArr = arr;
    ...
    value: function getPointList() {
      return this.pointArr.map(function (arr) {
        return arr.map(function (x) {
          return x;
        });
      });
    ...
    value: function getPointDistance(p0, p1) {
      var x = p0[0] - p1[0];
      var y = p0[1] - p1[1];
    ...
    value: function pow(num) {
      var k = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;

      return Math.pow(num, k);
    }
  }, {
    key: 'mouseDown',
    value: function mouseDown(e, cb) {
      ...
      if (num !== false) {
        ...
        if (ind !== false) {
          var len = this.pointArr.length;
          this.newPointIndexAtClosed = ind + 1;
          if (ind + 1 === len) {
    ...
    key: 'mouseMove',
    value: function mouseMove(e, cb) {
      if (this.isMouseDown && this.selPoint !== null) {
    ...
    key: 'isPointInCurve',
    value: function isPointInCurve(point) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_utils_curve__ = __webpack_require__(214);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    document.onkeydown = function (e) {
      e.preventDefault();
      if (e && (e.ctrlKey || e.metaKey) && (e.keyCode === 32 || e.keyCode === 8)) _this.currentDrawing.closePath();
  ...
  methods: {
    ...
    changeSize: function changeSize(_ref4) {
    ...
    createCurrentCanvas: function createCurrentCanvas() {
      if (!this.currentDrawing) {
        this.currentDrawing = new __WEBPACK_IMPORTED_MODULE_2_utils_curve__["a" /* default */]({
          el: this.$refs.currentCanvas
        });
      }
    },
    ...
    mousedownTarget1: function mousedownTarget1(e) {
      console.log(2);
      e.stopPropagation();
    },
...
// module
exports.push([module.i, ".header[data-v-34d6aaa3]{height:50px;line-height:50px;padding:0 20px}.main-container[data-v-34d6aaa3]{width:100%;height:calc(100% - 50px)}.tools[data-v-34d6aaa3]{padding:0 10px;height:100%}.tool-item[data-v-34d6aaa3]{height:40px}.canvas-c[data-v-34d6aaa3]{height:100%;position:relative}.bg-img-num1[data-v-34d6aaa3]{position:absolute;left:0;right:0;top:0;bottom:0;color:hsla(0,0%,100%,.65);background-color:#24292e;background-image:url(" + __webpack_require__(188) + "),linear-gradient(#191c20,#24292e 15%);background-repeat:repeat-x;background-position:center 0,0 0,0 0}.canvas-container[data-v-34d6aaa3]{position:absolute;left:0;right:0;top:0;bottom:0;margin:auto;overflow:hidden;background-image:url(\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA3NCSVQICAjb4U/gAAAABlBMVEXMzMz////TjRV2AAAACXBIWXMAAArrAAAK6wGCiw1aAAAAHHRFWHRTb2Z0d2FyZQBBZG9iZSBGaXJld29ya3MgQ1M26LyyjAAAABFJREFUCJlj+M/AgBVhF/0PAH6/D/HkDxOGAAAAAElFTkSuQmCC\");cursor:move}.canvas-actual-layer[data-v-34d6aaa3]{position:absolute}.current-canvas[data-v-34d6aaa3]{cursor:pointer}.canvas[data-v-34d6aaa3]{position:absolute;top:0;left:0}.cursor-move[data-v-34d6aaa3]{cursor:move}.img-draw[data-v-34d6aaa3]{cursor:crosshair}#ui-layer[data-v-34d6aaa3]{z-index:3}", "", {"version":3,"sources":["/Applications/XAMPP/xamppfiles/htdocs/XaircraftProject/web/Farming-AI/PC/src/views/polygon/index.vue"],"names":[],"mappings":"AACA,yBACE,YAAa,AACb,iBAAkB,AAClB,cAAgB,CACjB,AACD,iCACE,WAAY,AACZ,wBAA0B,CAC3B,AACD,wBACE,eAAgB,AAChB,WAAa,CACd,AACD,4BACE,WAAa,CACd,AACD,2BACE,YAAa,AACb,iBAAmB,CACpB,AACD,8BACE,kBAAmB,AACnB,OAAQ,AACR,QAAS,AACT,MAAO,AACP,SAAU,AACV,0BAA8B,AAC9B,yBAA0B,AAC1B,oFAA6F,AAC7F,2BAA4B,AAC5B,oCAAwC,CACzC,AACD,mCACE,kBAAmB,AACnB,OAAQ,AACR,QAAS,AACT,MAAO,AACP,SAAU,AACV,YAAa,AACb,gBAAiB,AACjB,+QAAgR,AAChR,WAAa,CACd,AACD,sCACE,iBAAmB,CACpB,AACD,iCACE,cAAgB,CACjB,AACD,yBACE,kBAAmB,AACnB,MAAO,AACP,MAAQ,CACT,AACD,8BACE,WAAa,CACd,AACD,2BACE,gBAAkB,CACnB,AACD,2BACE,SAAW,CACZ","file":"index.vue","sourcesContent":["\n.header[data-v-34d6aaa3] {\n  height: 50px;\n  line-height: 50px;\n  padding: 0 20px;\n}\n.main-container[data-v-34d6aaa3] {\n  width: 100%;\n  height: calc(100% - 50px);\n}\n.tools[data-v-34d6aaa3] {\n  padding: 0 10px;\n  height: 100%;\n}\n.tool-item[data-v-34d6aaa3] {\n  height: 40px;\n}\n.canvas-c[data-v-34d6aaa3] {\n  height: 100%;\n  position: relative;\n}\n.bg-img-num1[data-v-34d6aaa3] {\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  color: rgba(255,255,255,0.65);\n  background-color: #24292e;\n  background-image: url(../../assets/images/star-bg.svg),linear-gradient(#191c20, #24292e 15%);\n  background-repeat: repeat-x;\n  background-position: center 0, 0 0, 0 0;\n}\n.canvas-container[data-v-34d6aaa3] {\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  margin: auto;\n  overflow: hidden;\n  background-image: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA3NCSVQICAjb4U/gAAAABlBMVEXMzMz////TjRV2AAAACXBIWXMAAArrAAAK6wGCiw1aAAAAHHRFWHRTb2Z0d2FyZQBBZG9iZSBGaXJld29ya3MgQ1M26LyyjAAAABFJREFUCJlj+M/AgBVhF/0PAH6/D/HkDxOGAAAAAElFTkSuQmCC');\n  cursor: move;\n}\n.canvas-actual-layer[data-v-34d6aaa3] {\n  position: absolute;\n}\n.current-canvas[data-v-34d6aaa3] {\n  cursor: pointer;\n}\n.canvas[data-v-34d6aaa3] {\n  position: absolute;\n  top: 0;\n  left: 0;\n}\n.cursor-move[data-v-34d6aaa3] {\n  cursor: move;\n}\n.img-draw[data-v-34d6aaa3] {\n  cursor: crosshair;\n}\n#ui-layer[data-v-34d6aaa3] {\n  z-index: 3;\n}\n"],"sourceRoot":""}]);
...
var update = __webpack_require__(156)("5346f543", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    ref: "currentCanvas",
    staticClass: "canvas current-canvas",
    staticStyle: {
      "border": "1px solid red"
    },
    attrs: {
      "id": "current-canvas-layer",
      "width": _vm.imgBoxW,
      "height": _vm.imgBoxH
    }
  })])])])], 1)], 1)
...
//# sourceMappingURL=4.5afce293f37cf525cbdf.js.map