webpackJsonp([1],Array(154).concat([
/* 154 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_utils_file__ = __webpack_require__(166);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    previewImg: function previewImg(e) {
      var _this = this;
      this.file = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_utils_file__["a" /* getFile */])({ e: e });
      if (!this.file || !__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_utils_file__["b" /* isImage */])(this.file.ext)) {
        this.$alert('请选择以下图片类型：.gif/jpeg/jpg/png/bmp', '提示');
        return false;
      }
      this.img = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_utils_file__["c" /* fileTransformDataURL */])(this.file.file);
      var formdata = new FormData();
      formdata.append('file', this.file.file);
      console.log(this.file.file);
      console.log(formdata);
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('http://192.168.10.117:93/app/add_image', formdata).then(function (response) {
        console.log(response);
        _this.results = response.data.data.data;
...
// module
exports.push([module.i, ".page[data-v-15a7ae6a]{padding:10px 20px}.test-data-area[data-v-15a7ae6a]{padding:10px 0}.result-item[data-v-15a7ae6a]{position:relative}.result-img[data-v-15a7ae6a]{width:100%;display:block}.result-text[data-v-15a7ae6a]{position:absolute;top:0;left:10px;color:#fff;background-color:rgba(0,0,0,.5);width:calc(100% - 20px);line-height:30px;padding:0 5px}", "", {"version":3,"sources":["/Applications/XAMPP/xamppfiles/htdocs/XaircraftProject/web/Farming-AI/PC/src/views/result/index.vue"],"names":[],"mappings":"AACA,uBACE,iBAAmB,CACpB,AACD,iCACE,cAAgB,CACjB,AACD,8BACE,iBAAmB,CACpB,AACD,6BACE,WAAY,AACZ,aAAe,CAChB,AACD,8BACE,kBAAmB,AACnB,MAAO,AACP,UAAW,AACX,WAAY,AACZ,gCAAqC,AACrC,wBAAyB,AACzB,iBAAkB,AAClB,aAAc,CACf","file":"index.vue","sourcesContent":["\n.page[data-v-15a7ae6a] {\n  padding: 10px 20px;\n}\n.test-data-area[data-v-15a7ae6a] {\n  padding: 10px 0;\n}\n.result-item[data-v-15a7ae6a] {\n  position: relative;\n}\n.result-img[data-v-15a7ae6a] {\n  width: 100%;\n  display: block;\n}\n.result-text[data-v-15a7ae6a] {\n  position: absolute;\n  top: 0;\n  left: 10px;\n  color: #fff;\n  background-color: rgba(0, 0, 0, 0.5);\n  width: calc(100% - 20px);\n  line-height: 30px;\n  padding: 0 5px\n}\n"],"sourceRoot":""}]);
...
var update = __webpack_require__(156)("85afb132", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    }, [_vm._v(_vm._s(result.name) + "：" + _vm._s(result.score))])])
  }))], 1)], 1)], 1)])
},staticRenderFns: []}

/***/ })
]));
//# sourceMappingURL=1.6cfa4b25235f8955100e.js.map