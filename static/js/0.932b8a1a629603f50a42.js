...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_svg_js__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_svg_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_svg_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_utils_util__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_utils_file__ = __webpack_require__(164);
...
var Canvas = function () {
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Canvas, [{
    ...
    key: 'setActive',
    value: function setActive(_ref5) {
    ...
    key: 'setEdit',
    value: function setEdit(_ref6) {
      var editing = _ref6.editing;

      this.editing = editing;
    }
  }, {
    key: 'draging',
    value: function draging(_ref7) {
      var x = _ref7.x,
          y = _ref7.y;
    ...
    key: 'scaling',
    value: function scaling(_ref8) {
      var change = _ref8.change;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      _this.paintToolMainW = ~~window.getComputedStyle(_this.$refs.paintToolMain).width.replace('px', '');
      _this.paintToolMainH = ~~window.getComputedStyle(_this.$refs.paintToolMain).height.replace('px', '');
      _this.canvas = new Canvas({});
      _this.draw = __WEBPACK_IMPORTED_MODULE_2_svg_js___default()('svg');
    });
    this.$refs.img.onload = function () {
      _this.canvas.setSize({ w: _this.$refs.img.width, h: _this.$refs.img.height });
      if (_this.canvas.w > _this.paintToolMainW) _this.canvas.setScale({ scale: _this.paintToolMainW / _this.canvas.w });
      if (_this.canvas.h * _this.canvas.scale > _this.paintToolMainH) _this.canvas.setScale({ scale: _this.paintToolMainH / _this.canvas.h });
      _this.canvas.x = (_this.paintToolMainW - _this.canvas.w) / 2;
      _this.canvas.y = (_this.paintToolMainH - _this.canvas.h) / 2;
    };
    document.onkeydown = function (e) {
      e.preventDefault();
      if (e && (e.ctrlKey || e.metaKey) && e.keyCode === 68) _this.getJSON();
      if (e && (e.ctrlKey || e.metaKey) && e.keyCode === 90) _this.reback();
      if (e && e.key === 'Shift' || e.keyCode === 16) _this.selectEdit();
    };
  },
  ...
  methods: {
    ...
    previewImg: function previewImg(e) {
      this.file = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_utils_file__["a" /* getFile */])({ e: e });
      if (!this.file || !__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_utils_file__["b" /* isImage */])(this.file.ext)) {
    ...
    scaleImg: function scaleImg(e) {
      ...
      this.canvas.scaling({ change: change });
    },
    selectEdit: function selectEdit() {
...
// module
exports.push([module.i, ".paint-tool-main[data-v-609b3570]{overflow:hidden;background-image:url(\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA3NCSVQICAjb4U/gAAAABlBMVEXMzMz////TjRV2AAAACXBIWXMAAArrAAAK6wGCiw1aAAAAHHRFWHRTb2Z0d2FyZQBBZG9iZSBGaXJld29ya3MgQ1M26LyyjAAAABFJREFUCJlj+M/AgBVhF/0PAH6/D/HkDxOGAAAAAElFTkSuQmCC\")}.paint-box-move-layer[data-v-609b3570],.paint-tool-main[data-v-609b3570]{position:absolute;left:0;right:0;top:0;bottom:0}.paint-box-move-layer-hide[data-v-609b3570]{display:none}.header[data-v-609b3570]{height:50px;line-height:50px;padding:0 20px}.main-container[data-v-609b3570]{width:100%;height:calc(100% - 50px)}.tools[data-v-609b3570]{padding:0 10px;height:100%}.tool-item[data-v-609b3570]{height:40px}.canvas-c[data-v-609b3570]{height:100%;position:relative}.bg-img-num1[data-v-609b3570]{position:absolute;left:0;right:0;top:0;bottom:0;color:hsla(0,0%,100%,.65);background-color:#24292e;background-image:url(" + __webpack_require__(185) + "),linear-gradient(#191c20,#24292e 15%);background-repeat:repeat-x;background-position:center 0,0 0,0 0}.canvas-container[data-v-609b3570]{position:absolute;left:0;right:0;top:0;bottom:0;margin:auto;overflow:hidden;background-image:url(\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA3NCSVQICAjb4U/gAAAABlBMVEXMzMz////TjRV2AAAACXBIWXMAAArrAAAK6wGCiw1aAAAAHHRFWHRTb2Z0d2FyZQBBZG9iZSBGaXJld29ya3MgQ1M26LyyjAAAABFJREFUCJlj+M/AgBVhF/0PAH6/D/HkDxOGAAAAAElFTkSuQmCC\")}.canvas-actual-layer[data-v-609b3570]{position:relative}.canvas[data-v-609b3570]{position:absolute;top:0;left:0}.cursor-move[data-v-609b3570]{cursor:move}.img-draw[data-v-609b3570]{cursor:crosshair}#ui-layer[data-v-609b3570]{z-index:3}", "", {"version":3,"sources":["/Applications/XAMPP/xamppfiles/htdocs/XaircraftProject/web/AI/src/views/test/circle.vue"],"names":[],"mappings":"AACA,kCAME,gBAAiB,AACjB,8QAAgR,CACjR,AACD,yEARE,kBAAmB,AACnB,OAAQ,AACR,QAAS,AACT,MAAO,AACP,QAAU,CAUX,AACD,4CACE,YAAc,CACf,AAKD,yBACE,YAAa,AACb,iBAAkB,AAClB,cAAgB,CACjB,AACD,iCACE,WAAY,AACZ,wBAA0B,CAC3B,AACD,wBACE,eAAgB,AAChB,WAAa,CACd,AACD,4BACE,WAAa,CACd,AACD,2BACE,YAAa,AACb,iBAAmB,CACpB,AACD,8BACE,kBAAmB,AACnB,OAAQ,AACR,QAAS,AACT,MAAO,AACP,SAAU,AACV,0BAA8B,AAC9B,yBAA0B,AAC1B,oFAA6F,AAC7F,2BAA4B,AAC5B,oCAAwC,CACzC,AACD,mCACE,kBAAmB,AACnB,OAAQ,AACR,QAAS,AACT,MAAO,AACP,SAAU,AACV,YAAa,AACb,gBAAiB,AACjB,8QAAgR,CACjR,AACD,sCACE,iBAAmB,CACpB,AACD,yBACE,kBAAmB,AACnB,MAAO,AACP,MAAQ,CACT,AACD,8BACE,WAAa,CACd,AACD,2BACE,gBAAkB,CACnB,AACD,2BACE,SAAW,CACZ","file":"circle.vue","sourcesContent":["\n.paint-tool-main[data-v-609b3570] {\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  overflow: hidden;\n  background-image: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA3NCSVQICAjb4U/gAAAABlBMVEXMzMz////TjRV2AAAACXBIWXMAAArrAAAK6wGCiw1aAAAAHHRFWHRTb2Z0d2FyZQBBZG9iZSBGaXJld29ya3MgQ1M26LyyjAAAABFJREFUCJlj+M/AgBVhF/0PAH6/D/HkDxOGAAAAAElFTkSuQmCC');\n}\n.paint-box-move-layer[data-v-609b3570] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n}\n.paint-box-move-layer-hide[data-v-609b3570] {\n  display: none;\n}\n.paint-box[data-v-609b3570] {\n}\n.paint-box-img[data-v-609b3570] {\n}\n.header[data-v-609b3570] {\n  height: 50px;\n  line-height: 50px;\n  padding: 0 20px;\n}\n.main-container[data-v-609b3570] {\n  width: 100%;\n  height: calc(100% - 50px);\n}\n.tools[data-v-609b3570] {\n  padding: 0 10px;\n  height: 100%;\n}\n.tool-item[data-v-609b3570] {\n  height: 40px;\n}\n.canvas-c[data-v-609b3570] {\n  height: 100%;\n  position: relative;\n}\n.bg-img-num1[data-v-609b3570] {\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  color: rgba(255,255,255,0.65);\n  background-color: #24292e;\n  background-image: url(../../assets/images/star-bg.svg),linear-gradient(#191c20, #24292e 15%);\n  background-repeat: repeat-x;\n  background-position: center 0, 0 0, 0 0;\n}\n.canvas-container[data-v-609b3570] {\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  margin: auto;\n  overflow: hidden;\n  background-image: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA3NCSVQICAjb4U/gAAAABlBMVEXMzMz////TjRV2AAAACXBIWXMAAArrAAAK6wGCiw1aAAAAHHRFWHRTb2Z0d2FyZQBBZG9iZSBGaXJld29ya3MgQ1M26LyyjAAAABFJREFUCJlj+M/AgBVhF/0PAH6/D/HkDxOGAAAAAElFTkSuQmCC');\n}\n.canvas-actual-layer[data-v-609b3570] {\n  position: relative;\n}\n.canvas[data-v-609b3570] {\n  position: absolute;\n  top: 0;\n  left: 0;\n}\n.cursor-move[data-v-609b3570] {\n  cursor: move;\n}\n.img-draw[data-v-609b3570] {\n  cursor: crosshair;\n}\n#ui-layer[data-v-609b3570] {\n  z-index: 3;\n}\n"],"sourceRoot":""}]);
...
var update = __webpack_require__(154)("9d62a814", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("撤销")])], 1)], 1), _vm._v(" "), _c('el-row', {
    staticClass: "tool-item"
  }, [_c('el-tooltip', {
    staticClass: "item",
    attrs: {
    ...
    class: {
      'cursor-move': !_vm.canvas.editing, 'paint-box-move-layer-hide': _vm.canvas.editing
    },
    on: {
...
//# sourceMappingURL=0.932b8a1a629603f50a42.js.map